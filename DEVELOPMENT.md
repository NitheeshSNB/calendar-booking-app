...
```bash
git remote add encore encore://calendar-booking-app-wp5i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/calendar-booking-app-wp5i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/calendar-booking-app-wp5i/settings/integrations/github)
